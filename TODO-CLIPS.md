# TODO — Demo clips to record (owner 4.0/5.0 ruling 2026-07-03)

Owner's recording wish-list. Everything cuttable from existing footage has been cut
(Jaeger source → `battery-video/jband/`); these need new camera time. Check off as
...
- [ ] `wash-knee-forehand.mp4` — 02 Knee Short Hops, Forehand
- [ ] `wash-knee-backhand.mp4` — 03 Knee Short Hops, Backhand
- [ ] `wash-stand-barehand.mp4` — 04 Stand, No Glove / Bare Hand
- [ ] `wash-stand-glove.mp4` — 05 Stand, Glove / Short Hop Mix
- [ ] `wash-number-hops.mp4` — 06 Number-The-Hops Drill

## Bauer International (5)
- [ ] `bi-toe-touch.mp4` — 01 Single-Leg Toe Touch w/ Bar Assist
- [ ] `bi-squat-series.mp4` — 02 Bodyweight Squat Series
- [ ] `bi-step-overs.mp4` — 03 Lateral Step-Overs
...
- [ ] `fd-arm-circles.mp4` — 02 Arm Circles
- [ ] `fd-lunge-twist.mp4` — 03 Walking Lunge with Twist
- [ ] `fd-high-knees.mp4` — 04 High Knees + Butt Kicks
- [ ] `fd-hip-circles.mp4` — 05 Hip Circles (All-Fours)
- [ ] `fd-tspine.mp4` — 06 Side-Lying T-Spine Rotation

## Stretches (6)
- [ ] `fs-sleeper.mp4` — 07 Sleeper Stretch
- [ ] `fs-couch.mp4` — 08 Couch Stretch
- [ ] `fs-9090-hip.mp4` — 09 90/90 Hip Stretch
- [ ] `fs-crossbody.mp4` — 10 Shoulder Cross-Body Stretch
- [ ] `fs-wrist-flexor.mp4` — 11 Wrist Flexor Stretch
- [ ] `fs-calf-ankle.mp4` — 12 Calf / Ankle Dorsiflexion

## J-Band gaps (2) — not in the official Jaeger video
- [ ] `jbj-ir-alt.mp4` — 09 Elevated Internal Rotation (Alt angle)
